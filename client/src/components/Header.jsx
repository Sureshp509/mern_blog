  ...
  return (
    <Navbar className='border-b-2'>
      <Link to="/" className='self-center whitespace-nowrap font-semibold'>
        <span className='px-2 py-1 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 rounded-lg' >Suresh's</span> Blog
      </Link>
      <form>
      ...
      <div className='flex gap-2'>
        ...
        <Link to="/signIn" ><Button gradientDuoTone="purpleToBlue">SignIn</Button></Link>
